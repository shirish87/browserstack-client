 ...
 *
 * @class
 * @classdesc Create and manage Screenshot jobs running under the BrowserStack Screenshots API.
 * @version  v1
 * @param {object} options - Options for ScreenshotsClient. Optional.
 ...
 * @param  {number} options.wait_time - Time to wait (seconds) before taking the screenshot. Values: 2, 5, 10, 15, 20, 60.
 * @param  {string} options.callback_url - Publicly accessible URL to be used to send results after processing is complete.
 * @param  {callback} callback - Optional callback. Use promise or callback.
 * @return {Promise} Bluebird Promise object
 * @public
 */
ScreenshotsClient.prototype.createJob = function createJob(options, callback) {
  return this._request({
    method: 'POST',
    data: options
  }).nodeify(callback);
 ...
 * @public
 */
ScreenshotsClient.prototype.getJob = function getJob(jobId, callback) {
