 ...
 *
 * @class
 * @classdesc Access and manage information about your tests.
 * @version  v1
 * @param {object} options Options for AutomateClient
 * @public
 */
 ...
 * @param  {string} options.limit - Maximum no. of results to be displayed. Default: 10.
 ...
 * @param  {object} options - Options for this request.
 * @param  {int} options.limit - Maximum no. of results to be displayed. Default: 10.
 * @param  {string} options.status - Values: running, done, failed.
 * @param  {callback} callback - Optional callback. Use promise or callback.
 * @return {Promise} Bluebird Promise object
 * @public
 ...
 *
 * @param  {string} buildId - Build ID for the build.
