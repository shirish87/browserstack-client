...
describe("AutomateClient", () => {
  ...
  describe("Build", () => {
    ...
    test.skip<BrowserStackTestContext>("deleteBuild", async ({ automate: { client, randomBuildId } }) => {
      const buildId = await randomBuildId();
    ...
    test.only<BrowserStackTestContext>("uploadBuildTerminalLogs", async ({ automate: { client, randomBuildId } }) => {
      const buildId = await randomBuildId();
  ...
  describe("Session", () => {
    ...
    test.skip<BrowserStackTestContext>("deleteSession", async ({ automate: { client, randomSessionId } }) => {
      const sessionId = await randomSessionId();
    ...
    test.skip<BrowserStackTestContext>("deleteSessions", async ({ automate: { client, randomSessionId } }) => {
      const sessionId = await randomSessionId();
    ...
    test<BrowserStackTestContext>("getSessionLogs", async ({ automate: { client, randomSessionId } }) => {
      const sessionId = await randomSessionId();
    ...
    test<BrowserStackTestContext>("getSessionNetworkLogs", async ({ automate: { client, randomSessionId } }) => {
      const sessionId = await randomSessionId();
    ...
    test<BrowserStackTestContext>("uploadSessionTerminalLogs", async ({ automate: { client, randomSessionId } }) => {
      const sessionId = await randomSessionId();
