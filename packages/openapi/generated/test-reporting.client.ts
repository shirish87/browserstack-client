 ...
 */
  uploadReport(body: ({ file: Blob } | { url: string }) & { fileName: string } & Record<string, unknown>, options?: ExecuteOptions): Promise<DeepCamelCase<operations["uploadTestReportingReport"]["responses"][200]["content"]["application/json"]>> {
    return (this.execute({
      path: "/upload",
      params: undefined,
      requestInput: toSnakeCase(body, {"file":"data","projectName":"projectName","buildName":"buildName","buildIdentifier":"buildIdentifier","frameworkVersion":"frameworkVersion","versionControl":"versionControl"}),
      requestCodec: "multipart",
      requestCodecConfig: {"fileField":"data","filenameFrom":"$.file_name"},
      responseCodec: "json",
      responseCodecConfig: {},
