...
func (c *AccessibilityClient) GetWorkflowAnalyzerReportSummary(ctx context.Context, report_id int) (*WorkflowAnalyzerReportSummary, error) {
...
func (c *AccessibilityClient) GetWorkflowAnalyzerReportIssues(ctx context.Context, report_id int, task_id string, next_page string) (*WorkflowAnalyzerReportIssues, error) {
...
func (c *AccessibilityClient) GetAssistedTestReportSummary(ctx context.Context, report_id int) (*AssistedTestReportSummary, error) {
...
func (c *AccessibilityClient) GetAssistedTestReportIssues(ctx context.Context, report_id int, task_id string, next_page string) (*AssistedTestReportIssues, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanOverview(ctx context.Context, scan_id int) (*WebsiteScannerScanOverview, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanRuns(ctx context.Context, scan_id int, page int, page_size int) (*WebsiteScannerScanRunList, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanRunSummary(ctx context.Context, scan_id int, scan_run_id int) (*WebsiteScannerScanRunSummary, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanRunStatus(ctx context.Context, scan_id int, scan_run_id int) (*WebsiteScannerScanRunStatus, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanRunIssues(ctx context.Context, scan_id int, scan_run_id int, task_id string, next_page string) (*WebsiteScannerScanRunIssues, error) {
...
func (c *AccessibilityClient) GetWebsiteScannerScanRunLogs(ctx context.Context, scan_id int, scan_run_id int) (*WebsiteScannerScanRunLogs, error) {
...
func (c *AccessibilityClient) GetAutomatedTestBuilds(ctx context.Context, next_page string, projectId int) (*AutomatedTestsBuildList, error) {
