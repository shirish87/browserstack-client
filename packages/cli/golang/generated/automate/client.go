...
func (c *AutomateClient) GetAutomateBrowsers(ctx context.Context) (*BrowserList, error) {
	var out BrowserList
...
func (c *AutomateClient) GetAutomatePlan(ctx context.Context) (*AutomatePlan, error) {
...
func (c *AutomateClient) UpdateAutomateBuild(ctx context.Context, buildId string, body *UpdateAutomateBuildRequest) (*map[string]any, error) {
...
func (c *AutomateClient) GetAutomateSessions(ctx context.Context, buildId string, limit string, offset string, status string) (*map[string]any, error) {
	var out map[string]any
...
func (c *AutomateClient) UpdateAutomateProject(ctx context.Context, projectId string, body *UpdateAutomateProjectRequest) (*AutomateProject, error) {
...
func (c *AutomateClient) GetAutomateMediaFiles(ctx context.Context) (*map[string]any, error) {
	var out map[string]any
...
func (c *AutomateClient) GetAutomateProjects(ctx context.Context) (*map[string]any, error) {
	var out map[string]any
...
func (c *AutomateClient) GetAutomateBuilds(ctx context.Context, projectId string, limit string, offset string, status string) (*map[string]any, error) {
	var out map[string]any
