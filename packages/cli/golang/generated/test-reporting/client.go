...
func (c *TestReportingClient) GetProjectBuilds(ctx context.Context, projectId string, unique_build_names string, build_tags string, build_status string, users string, frameworks string, is_archived string, date_range string, next_page string) (*GetTestReportingProjectBuildsResponse, error) {
	var out GetTestReportingProjectBuildsResponse
	if err := c.http.Get(ctx, "/projects/" + url.PathEscape(projectId) + "/builds", map[string]string{"unique_build_names": unique_build_names, "build_tags": build_tags, "build_status": build_status, "users": users, "frameworks": frameworks, "is_archived": is_archived, "date_range": date_range, "next_page": next_page}, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetBuild(ctx context.Context, buildId string) (*BuildDetails, error) {
	var out BuildDetails
	if err := c.http.Get(ctx, "/builds/" + url.PathEscape(buildId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) UpdateBuild(ctx context.Context, buildId string, body *UpdateTestReportingBuildRequest) (*UpdateTestReportingBuildResponse, error) {
	...
	if err := c.http.Patch(ctx, "/builds/" + url.PathEscape(buildId), body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) FinishBuild(ctx context.Context, buildHashedId string, body *FinishTestReportingBuildRequest) (*FinishTestReportingBuildResponse, error) {
	...
	if err := c.http.Put(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/finish", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) StartTestRun(ctx context.Context, buildHashedId string, body *StartTestRunRequest) (*StartTestReportingTestRunResponse, error) {
	...
	if err := c.http.Post(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/tests/start", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) FinishTestRun(ctx context.Context, buildHashedId string, testRunUuid string, body *FinishTestRunRequest) (*FinishTestReportingTestRunResponse, error) {
	...
	if err := c.http.Put(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/tests/" + url.PathEscape(testRunUuid) + "/finish", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) StartHookRun(ctx context.Context, buildHashedId string, body *StartHookRunRequest) (*StartTestReportingHookRunResponse, error) {
	...
	if err := c.http.Post(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/hooks/start", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) FinishHookRun(ctx context.Context, buildHashedId string, hookRunUuid string, body *FinishHookRunRequest) (*FinishTestReportingHookRunResponse, error) {
	...
	if err := c.http.Put(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/hooks/" + url.PathEscape(hookRunUuid) + "/finish", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) AddBuildLogs(ctx context.Context, buildHashedId string, body *AddTestReportingBuildLogsRequest) (*AddTestReportingBuildLogsResponse, error) {
	...
	if err := c.http.Post(ctx, "/builds/" + url.PathEscape(buildHashedId) + "/logs", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetTestRuns(ctx context.Context, buildId string, re_runs string, test_statuses string, is_flaky string, is_new_failure string, sort string, order string, next_page string) (*TestRunsResponse, error) {
	...
	if err := c.http.Get(ctx, "/builds/" + url.PathEscape(buildId) + "/testRuns", map[string]string{"re_runs": re_runs, "test_statuses": test_statuses, "is_flaky": is_flaky, "is_new_failure": is_new_failure, "sort": sort, "order": order, "next_page": next_page}, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetSelfHealingReport(ctx context.Context, buildUuid string) (*GetTestReportingSelfHealingReportResponse, error) {
	...
	if err := c.http.Get(ctx, "/builds/" + url.PathEscape(buildUuid) + "/selfHealingReport", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetQualityGateStatus(ctx context.Context, buildUuid string) (*QualityGateStatus, error) {
	...
	if err := c.http.Get(ctx, "/quality-gates/" + url.PathEscape(buildUuid), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetQualityGateSettings(ctx context.Context, projectName string) (*QualityGateSettings, error) {
	...
	if err := c.http.Get(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/settings", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) UpdateQualityGateSettings(ctx context.Context, projectName string, body *UpdateTestReportingQualityGateSettingsRequest) (*UpdateTestReportingQualityGateSettingsResponse, error) {
	...
	if err := c.http.Put(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/settings", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) CreateQualityGateProfile(ctx context.Context, projectName string, body *QualityGateProfileRequest) (*CreateTestReportingQualityGateProfileResponse, error) {
	...
	if err := c.http.Post(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/profiles", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) GetQualityGateProfile(ctx context.Context, projectName string, profileUuid string) (*QualityGateProfile, error) {
	...
	if err := c.http.Get(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/profiles/" + url.PathEscape(profileUuid), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) UpdateQualityGateProfile(ctx context.Context, projectName string, profileUuid string, body *QualityGateProfileRequest) (*UpdateTestReportingQualityGateProfileResponse, error) {
	...
	if err := c.http.Put(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/profiles/" + url.PathEscape(profileUuid), body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) DeleteQualityGateProfile(ctx context.Context, projectName string, profileUuid string) (*DeleteTestReportingQualityGateProfileResponse, error) {
	...
	if err := c.http.Delete(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/profiles/" + url.PathEscape(profileUuid), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *TestReportingClient) ToggleQualityGateProfile(ctx context.Context, projectName string, profileUuid string, body *ToggleTestReportingQualityGateProfileRequest) (*ToggleTestReportingQualityGateProfileResponse, error) {
	...
	if err := c.http.Put(ctx, "/quality-gates/" + url.PathEscape(projectName) + "/profiles/" + url.PathEscape(profileUuid) + "/toggle", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
