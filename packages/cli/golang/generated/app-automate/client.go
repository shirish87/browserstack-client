...
func (c *AppAutomateClient) GetBuild(ctx context.Context, buildId string) (*GetAppAutomateBuildResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) UpdateBuild(ctx context.Context, buildId string, body *UpdateAppAutomateBuildRequest) (*map[string]any, error) {
	...
	if err := c.http.Put(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + ".json", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteBuild(ctx context.Context, buildId string) (*DeleteAppAutomateBuildResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetMediaFilesByCustomId(ctx context.Context, customId string) (*map[string]any, error) {
	var out map[string]any
	if err := c.http.Get(ctx, "/app-automate/recent_media_files/" + url.PathEscape(customId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetSessionLogs(ctx context.Context, buildId string, sessionId string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/logs", nil)
}
...
func (c *AppAutomateClient) GetXCUITestApp(ctx context.Context, appId string) (*GetAppAutomateXCUITestAppResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/xcuitest/v2/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteXCUITestApp(ctx context.Context, appId string) (*DeleteAppAutomateXCUITestAppResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/xcuitest/v2/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetNetworkLogs(ctx context.Context, buildId string, sessionId string) (*GetAppAutomateNetworkLogsResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/networklogs", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) UploadBuildTerminalLogs(ctx context.Context, buildId string, file []byte, fileName string, fields map[string]string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/terminallogs", nil)
}
...
func (c *AppAutomateClient) UploadSessionTerminalLogs(ctx context.Context, sessionId string, file []byte, fileName string, fields map[string]string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/sessions/" + url.PathEscape(sessionId) + "/terminallogs", nil)
}
...
func (c *AppAutomateClient) GetProject(ctx context.Context, projectId string) (*GetAppAutomateProjectResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/projects/" + url.PathEscape(projectId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) UpdateProject(ctx context.Context, projectId string, body *UpdateAppAutomateProjectRequest) (*map[string]any, error) {
	var out map[string]any
	if err := c.http.Put(ctx, "/app-automate/projects/" + url.PathEscape(projectId) + ".json", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteProject(ctx context.Context, projectId string) (*DeleteAppAutomateProjectResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/projects/" + url.PathEscape(projectId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetAppiumLogs(ctx context.Context, buildId string, sessionId string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/appiumlogs", nil)
}
...
func (c *AppAutomateClient) DeleteApp(ctx context.Context, appId string) (*DeleteAppAutomateAppResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/app/delete/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetFlutterAndroidApp(ctx context.Context, appId string) (*GetAppAutomateFlutterAndroidAppResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/flutter-integration-tests/v2/android/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteFlutterAndroidApp(ctx context.Context, appId string) (*DeleteAppAutomateFlutterAndroidAppResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/flutter-integration-tests/v2/android/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetAppProfilingDataV2(ctx context.Context, buildId string, sessionId string) (*map[string]any, error) {
	var out map[string]any
	if err := c.http.Get(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/appprofiling/v2", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetSession(ctx context.Context, sessionId string) (*GetAppAutomateSessionResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/sessions/" + url.PathEscape(sessionId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) UpdateSession(ctx context.Context, sessionId string, body *UpdateAppAutomateSessionRequest) (*UpdateAppAutomateSessionResponse, error) {
	...
	if err := c.http.Put(ctx, "/app-automate/sessions/" + url.PathEscape(sessionId) + ".json", body, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteSession(ctx context.Context, sessionId string) (*DeleteAppAutomateSessionResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/sessions/" + url.PathEscape(sessionId) + ".json", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteMediaFile(ctx context.Context, mediaId string) (*DeleteAppAutomateMediaFileResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/custom_media/delete/" + url.PathEscape(mediaId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetEspressoApp(ctx context.Context, appId string) (*GetAppAutomateEspressoAppResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/espresso/v2/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteEspressoApp(ctx context.Context, appId string) (*DeleteAppAutomateEspressoAppResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/espresso/v2/apps/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetAppsByCustomId(ctx context.Context, customId string) (*map[string]any, error) {
	var out map[string]any
	if err := c.http.Get(ctx, "/app-automate/recent_apps/" + url.PathEscape(customId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetDeviceLogs(ctx context.Context, buildId string, sessionId string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/devicelogs", nil)
}

func (c *AppAutomateClient) GetAppProfilingDataV1(ctx context.Context, buildId string, sessionId string) (*map[string]any, error) {
	var out map[string]any
	if err := c.http.Get(ctx, "/app-automate/builds/" + url.PathEscape(buildId) + "/sessions/" + url.PathEscape(sessionId) + "/appprofiling", nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetFlutteriOSApp(ctx context.Context, appId string) (*GetAppAutomateFlutteriOSAppResponse, error) {
	...
	if err := c.http.Get(ctx, "/app-automate/flutter-integration-tests/v2/ios/test-package/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) DeleteFlutteriOSApp(ctx context.Context, appId string) (*DeleteAppAutomateFlutteriOSAppResponse, error) {
	...
	if err := c.http.Delete(ctx, "/app-automate/flutter-integration-tests/v2/ios/test-package/" + url.PathEscape(appId), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (c *AppAutomateClient) GetProjectBadgeKey(ctx context.Context, projectId string) (string, error) {
	return c.http.GetText(ctx, "/app-automate/projects/" + url.PathEscape(projectId) + "/badge_key", nil)
}
