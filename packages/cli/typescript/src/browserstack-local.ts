 ...
 *
 * @param options.accessKey - The BrowserStack access key.
 ...
 *
 * @param options.accessKey - The access key used to authenticate with BrowserStack.
 ...
 * If the access key is undefined, it falls back to the BROWSERSTACK_ACCESS_KEY or BROWSERSTACK_KEY env vars.
