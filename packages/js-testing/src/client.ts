...
import { components, operations, paths } from "@browserstack-client/openapi/js-testing";
 ...
 * @public
 */
export class JSTestingClient extends APIClient<paths> {
  /**
  ...
  constructor(options?: BrowserStackOptions) {
    super(
      options ?? {},
      options?.baseUrl ?? "https://api.browserstack.com/5",
      "https://api-cloud.browserstack.com",
      "@browserstack-client/js-testing",
      "6.0.0"
    );
  }
