...
func New(c *bshttp.Client) *LocalTestingClient {
	return &LocalTestingClient{http: c}
}

func (c *LocalTestingClient) GetLocalBinaryInstances(ctx context.Context, auth_token string, last string, state string) (*GetLocalBinaryInstancesResponse, error) {
...
func (c *LocalTestingClient) GetLocalBinaryInstance(ctx context.Context, localInstanceId string, auth_token string) (*GetLocalBinaryInstanceResponse, error) {
...
func (c *LocalTestingClient) DisconnectLocalBinaryInstance(ctx context.Context, localInstanceId string, auth_token string) (*DisconnectLocalBinaryInstanceResponse, error) {
