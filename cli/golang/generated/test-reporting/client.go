...
func (c *TestReportingClient) GetTestReportingProjectBuilds(ctx context.Context, projectId int, unique_build_names string, build_tags string, build_status string, users string, frameworks string, is_archived string, date_range string, next_page string) (*GetTestReportingProjectBuildsResponse, error) {
	...
	if err := c.http.Get(ctx, "/projects/" + projectId + "/builds", map[string]string{"unique_build_names": unique_build_names, "build_tags": build_tags, "build_status": build_status, "users": users, "frameworks": frameworks, "is_archived": is_archived, "date_range": date_range, "next_page": next_page}, &out); err != nil {
		return nil, err
	}
	return &out, nil
}

func (c *TestReportingClient) StartTestReportingBuild(ctx context.Context, body *StartTestReportingBuildRequest) (*StartTestReportingBuildResponse, error) {
...
func (c *TestReportingClient) GetTestReportingLatestBuild(ctx context.Context, project_name string, build_name string, user_name string, build_tags string, framework string) (*GetTestReportingLatestBuildResponse, error) {
	var out GetTestReportingLatestBuildResponse
...
func (c *TestReportingClient) GetTestReportingBuild(ctx context.Context, buildId string) (*GetTestReportingBuildResponse, error) {
	var out GetTestReportingBuildResponse
...
func (c *TestReportingClient) StartTestReportingTestRun(ctx context.Context, buildHashedId string, body *StartTestReportingTestRunRequest) (*StartTestReportingTestRunResponse, error) {
...
func (c *TestReportingClient) FinishTestReportingTestRun(ctx context.Context, buildHashedId string, testRunUuid string, body *FinishTestReportingTestRunRequest) (*FinishTestReportingTestRunResponse, error) {
...
func (c *TestReportingClient) StartTestReportingHookRun(ctx context.Context, buildHashedId string, body *StartTestReportingHookRunRequest) (*StartTestReportingHookRunResponse, error) {
...
func (c *TestReportingClient) FinishTestReportingHookRun(ctx context.Context, buildHashedId string, hookRunUuid string, body *FinishTestReportingHookRunRequest) (*FinishTestReportingHookRunResponse, error) {
...
func (c *TestReportingClient) GetTestReportingTestRuns(ctx context.Context, buildId string, re_runs string, test_statuses string, is_flaky string, is_new_failure string, sort string, order string, next_page string) (*GetTestReportingTestRunsResponse, error) {
	var out GetTestReportingTestRunsResponse
...
func (c *TestReportingClient) GetTestReportingQualityGateStatus(ctx context.Context, buildUuid string) (*GetTestReportingQualityGateStatusResponse, error) {
	var out GetTestReportingQualityGateStatusResponse
...
func (c *TestReportingClient) GetTestReportingQualityGateSettings(ctx context.Context, projectName string) (*GetTestReportingQualityGateSettingsResponse, error) {
	var out GetTestReportingQualityGateSettingsResponse
...
func (c *TestReportingClient) CreateTestReportingQualityGateProfile(ctx context.Context, projectName string, body *CreateTestReportingQualityGateProfileRequest) (*CreateTestReportingQualityGateProfileResponse, error) {
...
func (c *TestReportingClient) GetTestReportingQualityGateProfile(ctx context.Context, projectName string, profileUuid string) (*GetTestReportingQualityGateProfileResponse, error) {
	var out GetTestReportingQualityGateProfileResponse
...
func (c *TestReportingClient) UpdateTestReportingQualityGateProfile(ctx context.Context, projectName string, profileUuid string, body *UpdateTestReportingQualityGateProfileRequest) (*UpdateTestReportingQualityGateProfileResponse, error) {
